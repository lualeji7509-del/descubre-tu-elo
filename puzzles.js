...
const PUZZLES = [
...

  {
    level: 'gm',
    rating: 2300,
    fen: 'r5qk/p1p2p2/b1p1pp1B/7Q/8/2P5/PPP2PPP/3R2K1 w - - 0 18',
    solution: ['Bg5+', 'Qh7', 'Bxf6+', 'Kg8', 'Qg5+', 'Qg6', 'Qh4', 'Qh7', 'Rd4'],
    outcome: 'win',
    source: { es: 'Manuela Hernández – Susana de Prada · Open Internacional de Benasque, 2026', en: 'Manuela Hernández – Susana de Prada · Benasque International Open, 2026' },
    theme: { es: 'Jaques forzados', en: 'Forced checks' },
    explain: {
      es: 'La dama blanca en h5 apunta a h8 por toda la columna, pero su propio alfil en h6 le tapa el paso. Al saltar a g5 se descubre el jaque; las negras solo pueden taparlo con la dama. El alfil sigue el ataque comiendo en f6 con jaque por la otra diagonal, y el rey tiene que huir a g8. La dama vuelve a la columna g y las negras siguen defendiendo a la fuerza, jaque tras jaque. Ni siquiera pueden capturar la dama en h4: tras …Txh4 el mate en h8 es inevitable, y la torre blanca ya prepara Tg4 para clavar la pieza que defiende. Manuela lo jugó de verdad contra Susana de Prada, en el Open Internacional de Benasque, 2026.',
      en: 'The white queen on h5 aims straight down the h-file at h8, but her own bishop on h6 blocks the way. Jumping to g5 uncovers the check; Black can only block with the queen. The bishop keeps up the attack by capturing on f6 with check along the other diagonal, forcing the king to run to g8. The queen swings back to the g-file and Black keeps defending by force, check after check. Black cannot even grab the queen on h4: after …Rxh4 mate on h8 becomes unstoppable, and the white rook is already heading to g4 to pin the defender. Manuela played this for real against Susana de Prada, at the Benasque International Open, 2026.',
    },
  },
