/* ==========================================================================
   ...
   ── COMPROBAR QUE NO TE EQUIVOCASTE / CHECK YOUR PUZZLES ────────────────
   En la carpeta del proyecto:  node elo-maestros/verify.mjs
   El programa revisa que cada jugada sea legal y que los mates sean mate.
   It checks that every move is legal and that every claimed mate really is one.
   ========================================================================== */
